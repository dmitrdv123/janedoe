...
interface IJaneDoeV2 {
  ...
  event WithdrawTo(uint256 dt, address from, address to, address token, uint256 amount);
  event WithdrawToBatch(uint256 dt, address from, address[] to, address[] tokens, uint256[] amounts);
