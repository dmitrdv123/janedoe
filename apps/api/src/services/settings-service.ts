...
import { APP_SETTINGS_PREFIX, BLOCKCHAIN_EVM_CLIENT_CONFIG_SETTINGS_PREFIX, BLOCKCHAIN_SETTINGS_PREFIX, DEFAULT_ACCOUNT_PAYMENT_SETTINGS_PREFIX, TOKEN_SETTINGS_PREFIX } from '../constants'
import { TokenSettings } from '../interfaces/settings'
...
export class SettingsServiceImpl implements SettingsService {
  ...
  public async loadBlockchainSettings(blockchain: string): Promise<BlockchainSettings | undefined> {
    ...
    logger.debug('MetaTask: end to get blockchain settings')
    logger.debug(settings)
  ...
  public async saveBlockchainSettings(settings: BlockchainSettings): Promise<void> {
    ...
    logger.debug('MetaTask: end to save blockchain settings')
  }
