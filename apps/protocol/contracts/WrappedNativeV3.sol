...
contract WrappedNativeV3 is ERC20Upgradeable, ReentrancyGuardUpgradeable, IWrappedNative {
  uint8 private _decimals;

  function initialize3(string memory name_, string memory symbol_, uint8 decimals_) reinitializer(3) public {
