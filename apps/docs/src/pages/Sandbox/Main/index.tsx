...
import { CurrencyDollar, Envelope, Gear, GraphUpArrow, House, Wallet } from 'react-bootstrap-icons'
  ...
  return (
    <main className="d-flex flex-row">
      <Col md={3} sm={4} className="col-auto bg-dark overflow-auto vh-100 p-2">
        ...
        <Navbar bg="dark" data-bs-theme="dark" expand="sm" className='d-inline'>
          <Container>
            ...
            <Navbar.Collapse id="sidebar-nav">
              <Nav defaultActiveKey="#" className="nav-pills flex-column mb-auto w-100">
                <Nav.Link href="#home" className="text-white text-decoration-none">
                  <House />
                  <span className="ms-3">{t('pages.app.home')}</span>
                </Nav.Link>

                <Nav.Link href="#balances" className="text-white text-decoration-none">
                  <CurrencyDollar />
                  <span className="ms-3">{t('pages.app.balances')}</span>
                </Nav.Link>

                <Nav.Link href="#payments" className="text-white text-decoration-none">
                  <GraphUpArrow />
                  <span className="ms-3">{t('pages.app.payments')}</span>
                </Nav.Link>
