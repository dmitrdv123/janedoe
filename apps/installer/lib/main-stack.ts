...
function handler(event) {
  ...
  headers['content-security-policy'] = { value: "default-src 'none'; object-src 'none'; img-src * data: blob:; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; frame-src https://verify.walletconnect.com https://verify.walletconnect.org; connect-src 'self' ${output.httpApi?.apiEndpoint} wss://relay.walletconnect.com wss://relay.walletconnect.org https://api.web3modal.com wss://www.walletlink.org https://cloudflare-eth.com https://rpc.walletconnect.com" }
