...
import exchangeRate from './exchange-rate/reducer'
import accountSettings from './account-settings/reducer'
...
const store = configureStore({
  reducer: {
    application, meta, settings, accountSettings, exchangeRate
  },
