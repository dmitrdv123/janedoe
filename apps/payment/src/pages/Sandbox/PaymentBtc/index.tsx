            ...
            <Row>
              ...
              <Col sm={6}>
                <div className="mb-2">
                  ...
                  <InputGroup>
                    <Form.Control type="text" placeholder="сумма" value="0.1" readOnly />
                ...
                <div className="mb-2">
                  <Form.Label>Отправить на этот адрес</Form.Label>
                  <InputGroup>
                    <Form.Control type="text" placeholder="адрес" value="bcrt1p5wynksc3q6delhjx4py34mm86axxpafgxle589sdnyzsnpfqc76qjgglwh" readOnly />
                    <Button variant="outline-secondary">
                      <Clipboard />
                    </Button>
                  </InputGroup>
